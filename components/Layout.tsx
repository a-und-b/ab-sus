    ...
    <div className="min-h-screen flex flex-col font-sans bg-xmas-cream transition-colors duration-500">
      ...
      <footer className="bg-white border-t border-stone-100 text-stone-400 py-12 text-center text-sm mt-12">
        <div className="container mx-auto px-4">
          ...
          <p className="font-serif text-stone-600 mb-2">&copy; {new Date().getFullYear()} {config.title} Community.</p>
          <p className="text-stone-400">Gemacht mit <span className="text-xmas-pink">❤️</span> für Solo-Selbstständige.</p>
          ...
          <div className="mt-8 pt-6 border-t border-stone-50 inline-flex flex-wrap justify-center gap-4 text-xs text-stone-400">
             ...
             <a href="#/admin" onClick={safeNavigate('#/admin')} className="hover:text-xmas-red transition-colors">
               Admin
             </a>
             <span>•</span>
             <a href="#/p/a3f7k9m2" onClick={safeNavigate('#/p/a3f7k9m2')} className="hover:text-xmas-red transition-colors">
               Gast (Anna)
             </a>
             <span>•</span>
             <a href="#/p/b8x2l1p9" onClick={safeNavigate('#/p/b8x2l1p9')} className="hover:text-xmas-red transition-colors">
               Gast (Markus)
             </a>
             <span>•</span>
             <a href="#/p/judith-demo" onClick={safeNavigate('#/p/judith-demo')} className="hover:text-xmas-red transition-colors">
               Gast (Judith)
             </a>
          </div>
        </div>
